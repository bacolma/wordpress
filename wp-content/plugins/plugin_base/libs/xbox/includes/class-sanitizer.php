...
class Sanitizer
{
    ...
    */
    public function number ()
    {
        ...
        $value = trim( $this->value );
        $valid_number = true;
        if ( in_array( $value , [ 'auto' , 'initial' , 'inherit' , 'normal' ] ) ) {
            return $this->sanitize_value( $value );
        }
    ...
    */
    ...
    {
        $options = $this->field->arg( 'options' );
        $value = $this->validate_single_value( $this->value , [ $options[ 'on_value' ] , $options[ 'off_value' ] ] , true );
        return $this->sanitize_value( $value );
    }
    ...
    */
    ...
    |---------------------------------------------------------------------------------------------------
    */
    public function validate_multiple_values ( $value = [] , $valid_values = NULL , $set_default = true )
    {
